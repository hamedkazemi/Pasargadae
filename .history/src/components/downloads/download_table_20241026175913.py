...
class DownloadTable(QTableWidget):
    ...
    def setup_sorting(self):
        ...
        # Don't allow sorting on checkbox and icon columns
    ...
    def handle_sort(self, logical_index):
        ...
        # Toggle sort order
        if self.horizontalHeader().sortIndicatorSection() == logical_index:
            if self.horizontalHeader().sortIndicatorOrder() == Qt.SortOrder.AscendingOrder:
                self.horizontalHeader().setSortIndicator(logical_index, Qt.SortOrder.DescendingOrder)
            else:
