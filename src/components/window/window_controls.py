...
class WindowControls(QWidget):
    ...
    def setup_ui(self):
        ...
        layout.setSpacing(8)  # Add spacing between buttons
        
        # Minimize button
        self.minimize_btn = QPushButton()
        self.minimize_btn.setFixedSize(28, 28)  # Make buttons square
        ...
        self.close_btn.setFixedSize(28, 28)  # Make buttons square
        ...
        layout.addSpacing(10)  # Add right margin
